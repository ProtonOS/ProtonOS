...
// These are duplicated from ExceptionHandling.cs for now - could be moved to a shared location.
...
internal unsafe struct ImageDosHeader
{
    ...
    public ulong e_res;         // 4 reserved words
...
[StructLayout(LayoutKind.Sequential, Pack = 1)]
internal unsafe struct ImageOptionalHeader64
{
    ...
    // Data directories follow - we'll access via pointer arithmetic
...
{
    // Name is 8 bytes, we split it for easy comparison
